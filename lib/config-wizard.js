...
class ConfigWizard {
    ...
    renderCredentialsStep() {
        ...
        return `
            <div class="wizard-step-description">
                Connectez-vous à ${platformInfo.name} avec un token d'accès personnel.
            </div>
            ...
            <form class="wizard-form" id="credentials-form">
                ...
                <div class="wizard-field">
                    <label>
                        ...
                        <span class="field-help">(automatiquement rempli)</span>
                    </label>
                    <input type="text"
                           id="wizard-owner"
                ...
                <div class="wizard-field">
                    <label>
                        Nom du repository
                        <span class="field-help">(ex: Pensine-StephaneDenis)</span>
                    </label>
                    <input type="text"
                           id="wizard-repo"
                ...
                <div class="wizard-field">
                    <label>
                        Branche principale
                        <span class="field-help">(généralement "main" ou "master")</span>
                    </label>
                    <input type="text"
                           id="wizard-branch"
                ...
                ${!this.tokenValidated ? `
                    <div class="wizard-info-box" style="background: #fff5b1; border-left: 4px solid #fa0; padding: 15px; margin: 15px 0;">
                        <strong>ℹ️ Validation requise</strong>
                        <p>Veuillez valider votre token avant de configurer le repository.</p>
                    </div>
                ` : ''}
            </form>
        `;
